...
describe("GET /", () => { // describe breaks test suite into components -> BIGGER UNIT test; can imagine integrations
  it("GET / => array of items", () => { // it performs individual tests -> UNIT test
    return request(app)
      .get("/")
